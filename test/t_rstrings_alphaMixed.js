...
describe("rstrings.alphaMixed function", function () 
{
   ...
   {
      var data = rstrings.alphaMixed(30);
   ...
   {
      var data = rstrings.alphaMixed(30);
      expect(data, "data contents invalid").to.match(/^[abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ]*$/);
   });

      //----------------------------------------------------------------------------
   it(`should support 0 length strings`, function () 
   {
      var data = rstrings.alphaMixed(0);
   ...
   {
      var data = rstrings.alphaMixed(0.5);
      expect(data, "data contents invalid").to.equal("");
   });
   ...
   {
      var data = rstrings.alphaMixed(-1);
      expect(data, "data contents invalid").to.equal("");
   });
   ...
   {
      var data = rstrings.alphaMixed(10.54);
