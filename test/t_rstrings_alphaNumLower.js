...
describe("rstrings.alphaNumLower function", function () 
{

      //----------------------------------------------------------------------------
   it(`should return string`, function () 
   {
      var data = rstrings.alphaNumLower(30);
   ...
   {
      var data = rstrings.alphaNumLower(0);
   ...
   {
      var data = rstrings.alphaNumLower(0.5);
      expect(data, "data contents invalid").to.equal("");
   });
   ...
   {
      var data = rstrings.alphaNumLower(-1);
      expect(data, "data contents invalid").to.equal("");
   });
   ...
   {
      var data = rstrings.alphaNumLower(10.54);
